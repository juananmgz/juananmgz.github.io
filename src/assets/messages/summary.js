const summary = {
  en: {
    ...
    paragraph: [
      ...
      `My toolkit: JavaScript on Vue and React daily, a Master's in Agile Web Development (A-), an <span class="highlight">Honour Mention</span> Computer Engineering degree, and a Google UX Design certificate to back the design instincts. I design, architect, then build — and the proposals I draft tend to ship.`,
      `Off the clock, I'm an award-winning <span class="highlight">traditional musician</span>, a folklore researcher, and a stubborn <span class="highlight">German</span> learner. Turns out thinking in melodies makes for better interfaces (~◡^).`,
    ],
  },
};
